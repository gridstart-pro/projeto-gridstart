...
echo "iniciando verificação do sistema de backup"
...
# TODO: Implementar rotacao de log (Mover monitorar.log para monitorar.log.bak ao atingir 1MB) Nível de LOG ERRO
